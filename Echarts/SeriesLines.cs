...
namespace Echarts
{
	...
	public class SeriesLines
	{
		...
		public SeriesLines_MarkLine MarkLine { get; set; }

		/// <summary>
		/// 图表标域，常用于标记图表中某个范围的数据，例如标出某段时间投放了广告。
		/// </summary>
		[JsonProperty("markArea")]
		public SeriesLines_MarkArea MarkArea { get; set; }
	...
	/// 图表标线。
	/// </summary>
	public class SeriesLines_MarkLine
	{
		/// <summary>
		/// 图形是否不响应和触发鼠标事件，默认为 false，即响应和触发鼠标事件。
		/// </summary>
		...
		/// </summary>
		[JsonProperty("data")]
		public SeriesLines_MarkLine_Data Data { get; set; }
	...
	/// }
	/// </summary>
	public class SeriesLines_MarkLine_Data
	{
		/// <summary>
		/// 起点的数据。
		/// </summary>
	...
	/// 图表标域，常用于标记图表中某个范围的数据，例如标出某段时间投放了广告。
	/// </summary>
	public class SeriesLines_MarkArea
	{
		/// <summary>
		/// 图形是否不响应和触发鼠标事件，默认为 false，即响应和触发鼠标事件。
		/// </summary>
		...
		/// </summary>
		[JsonProperty("data")]
		public SeriesLines_MarkArea_Data Data { get; set; }
	...
	/// }
	/// </summary>
	public class SeriesLines_MarkArea_Data
	{
		/// <summary>
		/// 标域左上角的数据
		/// </summary>
