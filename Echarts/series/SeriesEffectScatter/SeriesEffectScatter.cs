...
namespace Echarts
{
	...
	/// </summary>
	public class SeriesEffectScatter
	{
		/// <summary>
		/// </summary>
		[JsonProperty("type")]
		...
		/// </summary>
		[JsonProperty("showEffectOn")]
		public string ShowEffectOn { get; set; }

		/// <summary>
		///     涟漪特效相关配置。
		/// </summary>
		[JsonProperty("rippleEffect")]
		public SeriesEffectScatter_RippleEffect RippleEffect { get; set; }
		...
		/// </summary>
		[JsonProperty("data")]
		public SeriesEffectScatter_Data[] Data { get; set; }

		/// <summary>
		///     图表标注。
		/// </summary>
		[JsonProperty("markPoint")]
		public SeriesEffectScatter_MarkPoint MarkPoint { get; set; }
