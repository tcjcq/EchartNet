...
namespace Echarts
{
	...
	///     参见例子：
	/// </summary>
	public class SeriesPictorialBar
	{
		/// <summary>
		/// </summary>
		[JsonProperty("type")]
		...
		public SeriesPictorialBar_Emphasis Emphasis { get; set; }
		...
		public SeriesPictorialBar_AnimationEasingUpdate AnimationEasingUpdate { get; set; }
		...
		/// </summary>
		[JsonProperty("data")]
		public SeriesPictorialBar_Data[] Data { get; set; }

		/// <summary>
		///     图表标注。
		/// </summary>
		[JsonProperty("markPoint")]
		public SeriesPictorialBar_MarkPoint MarkPoint { get; set; }
