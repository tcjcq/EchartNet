...
namespace Echarts
{
	...
	public class SeriesBoxplot
	{
		...
		public SeriesBoxplot_Emphasis Emphasis { get; set; }
		...
		/// </summary>
		[JsonProperty("data")]
		public SeriesBoxplot_Data[] Data { get; set; }

		/// <summary>
		///     图表标注。
		/// </summary>
		[JsonProperty("markPoint")]
		public SeriesBoxplot_MarkPoint MarkPoint { get; set; }
