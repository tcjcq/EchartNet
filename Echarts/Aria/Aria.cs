...
/// <summary>
///     W3C 制定了无障碍富互联网应用规范集（WAI-ARIA，the Accessible Rich Internet Applications Suite），致力于使得网页内容和网页应用能够被更多残障人士访问。Apache
///     ECharts 4 遵从这一规范，支持自动根据图表配置项智能生成描述，使得盲人可以在朗读设备的帮助下了解图表内容，让图表可以被更多人群访问。除此之外，Apache ECharts 5
///     新增支持贴花纹理，作为颜色的辅助表达，进一步用以区分数据。
...
public class Aria
{
	...
	///     }
	///     }
	///     绝大部分支持填充色的系列都支持贴花图案，包括：'line', 'bar', 'pie', 'radar', 'treemap', 'sunburst', 'boxplot', 'sankey', 'funnel',
	///     'gauge', 'pictorialBar', 'themeRiver', 'custom' 等。其中，部分系列默认没有填充色（如 'line', 'radar', 'boxplot'）需要在设置了填充样式 areaStyle
	///     的情况下才生效。
	/// </summary>
	[JsonProperty("decal")]
